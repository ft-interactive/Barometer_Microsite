...
(function(FTi) {
	// create environment
	/*
		<div style="width: 610px; height: 50px; position: absolute; top: 180px; left: 150px; z-index:600">
		...
		<div id="countryBarsTitle"></div>
		<div id="container_countryBars" style="width: 420px; height: 290px; position: absolute; top: 447px; left: 1px; z-index:600" ></div>
		<div id="container_topicalBars" style="width: 420px; height: 550px; position: absolute; top: 444px; left: 450px; z-index:600" ></div>
		<div id="container_pieTopical" style="width: 580px; height: 240px; position: absolute; top: 230px; left: 144px; z-index:600" ></div>
	*/
	var htmlElements = '';
	...
	FTi.wrBlurb(3);
	//FTi.topical[FTi.dataset.cData[0]][FTi.dataset.cData[1]][FTi.dataset.cData[2]] = function(){console.log('2012 q2')};
